...
::: {.domain-card}
### ESG Analytics
Climate scenario modelling, net-zero simulation,
...
:::
::: {.g-col-12 .g-col-md-6}
[**Net Zero Municipal Simulation**](projects/net-zero-sim.qmd){.project-card}

Monte Carlo scenario modelling of climate target pathways
for a German municipality.

<span class="tag tag-esg">ESG</span>
<span class="tag tag-method">Simulation · Python</span>
:::
::: {.g-col-12 .g-col-md-6}
